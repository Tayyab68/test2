...
<section class="section">
    <nav class="card-tab">
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a href="{{ route('liveCategories') }}" class="nav-link active">
                {{ __('liveCategory') }}
            </a>
        </div>
    </nav>
    <div class="card">
        <div class="card-header">
            <div class="page-title w-100">
                <div class="d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 fw-semibold">{{ __('liveCategory') }}</h4>
                    <button type="button" class="btn theme-bg theme-btn text-white" data-bs-toggle="modal"
                        data-bs-target="#categoryModal" id="addLiveCategoryType">
                        {{ __('addLiveCategory') }}
                    </button>
                </div>
            </div>
        ...
        <div class="card-body">
            <table class="table table-striped w-100" id="liveCategoryTable">
                <thead>
                    <tr>
        ...
        <div class="modal-dialog modal-sm-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-semibold" id="exampleModalLabel">{{ __('addLiveCategory') }}</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="addCategoryForm" method="post">
                    <div class="modal-body">
                        <input type="hidden" class="form-control" name="type" id="categoryType" value="1" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="posterImg">
                                ...
                                <div class="upload-options">
                                    <label for="poster"> 
                                        <input type="file" accept=".png, .jpg, .jpeg, .webp, .gif" onchange="loadFile(event)" name="image" id="poster" required>
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-semibold" id="exampleModalLabel">{{ __('editLiveCategory') }}</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="posterImg editContent">
                                ...
                                <div class="upload-options">
                                    <label for="poster1"> 
                                        <input type="file" accept=".png, .jpg, .jpeg, .webp, .gif" onchange="loadFileEdit(event)" name="image" id="poster1">
                                    </label>
                                </div>
                            </div>
                        </div>
